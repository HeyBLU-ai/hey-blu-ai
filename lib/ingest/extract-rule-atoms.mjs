...
6. RULE NUMBER INHERITANCE: If a chunk of text is a sub-clause, lettered list item (A, B, C, …), or numbered bullet (1, 2, 3, …) that belongs to a parent rule, you MUST assign the parent rule's exact number to that chunk. Do NOT leave "rule_number" empty or treat sub-clauses as unnumbered just because the sub-clause heading does not repeat the parent number. Example: "C. Mercy Rules" falls under "405. Length of Game" — the "rule_number" for that atom MUST be "405", not "".
