...
(function () {
    ...
    var TOKEN_ALIASES = {
        ...
        price: ['price', 'pricing', 'cost', 'costs', 'subscription', 'trial', '12.99', '79.99'],
        ...
        zone: ['zone', 'strike zone', 'resize zone', 'zone size', 'age preset', 'short tall'],
        ...
        pitcher: ['pitcher', 'pitchers', 'roster', 'name', 'names', 'switch pitcher'],
        delete: ['delete', 'trash', 'remove pitch', 'phantom', 'throwback', 'counted mistake'],
        left: ['left', 'lefty', 'left-handed', 'lhb', 'batter obstruction'],
        drift: ['drift', 'drifted', 'arkit', 'position', 'sensor', 'dirt field', 'all dirt'],
        phantom: ['phantom', 'throwback', 'fake', 'false', 'counted', 'trash', 'delete pitch'],
        detection: ['detection', 'detections', 'no call', 'silent', 'missed', 'confidence', 'sensitivity'],
        contact: ['contact', 'batted', 'grounder', 'hit', 'contamination', 'live at bats'],
        bullpen: ['bullpen', 'live at bats', 'mode', 'audio', 'muted', 'batter box'],
        battery: ['battery', 'charge', 'charged', 'power'],
        pro: ['pro', 'pro max', 'measuring tape', 'distance', 'lens height', 'measurements'],
        adjust: ['adjust plate', 'adjust', 'overhead', 'birds eye', 'bird s eye', 'slide plate'],
        command: ['command center', 'ipad', 'second device', 'second phone', 'remote', 'follow game'],
        wrong: ['wrong call', 'bad call', 'decision', 'playbook', 'every pitch outside', 'every pitch inside'],
        size: ['zone size', 'resize', 'too high', 'too low', 'too inside', 'too outside', 'age group', 'preset']
    };
